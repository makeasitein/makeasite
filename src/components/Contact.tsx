...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-32 bg-gradient-to-br from-[#F8F8F8] via-white to-[#E8F5F2] relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#1E64F0] to-[#0F7B5F] text-white px-8 py-4 rounded-xl hover:shadow-xl transition-all flex items-center justify-center gap-2 group"
              >
                Send Message
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="mb-1">Chat on WhatsApp</h3>
